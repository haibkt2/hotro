	...
	<div id="container">
		...
		<div id="body" class="width">
			...
			<span style="font-size: 30px; cursor: pointer;"
				id="mainsideaccoutsub" onclick="opensideaccoutsub()"
				class="fa fa-bars"> Open </span> <br>
			 <br>
				...
				<a style="text-align: left; font-size: xx-large;"
					href="${pageContext.request.contextPath}/AddNewNotify?addNewNotify=add">Thêm thông báo mới
					</a><br> 
					<br>
				<p style="text-align: center;color: red;font-size: 18px">${add_nt}</p>
				<section> <br>
...
<%-- 				%> --%>
				...
				<br>
					<input type="checkbox" id="myCheck"  checked onclick="myFunction()" style="margin-bottom: 30px;"> Show all
				<script>
function myFunction() {
    var checkBox = document.getElementById("myCheck");
    var text = document.getElementById("bootstrap-table");
    var text_f = document.getElementById("table-footer");
       ...
       text_f.style.display = "none";
				...
				<table id="bootstrap-table" border="1"
					...
					<tbody>
						...
						<%
							List<notify> listNt= (ArrayList) request.getAttribute("listNt");
							int i=1;
								for (notify nt : listNt) {
						%>
						<tr>
							<td><%=i++%></td>
							<td><%=nt.getContent()%></td>
							...
							<td><a style="color: red;"
								href="${pageContext.request.contextPath}/DeleteNotify?idnt=<%=nt.getId()%>">Xóa</a></td>
						</tr>
						<%
