...
<body>
	<div id="container">
		...
		<div id="body" class="width">
			...
			</script> <a style="text-align: left; font-size: xx-large;"
				href="${pageContext.request.contextPath}/AddNewUser?addNewUser=addUser">Thêm
				mới user</a>
			<br>
			<br>
			<p style="text-align: center; color: red; font-size: 18px">${add_user}</p>
			...
			<table id="bootstrap-table" border="1"
				...
				<tbody>
					...
					<%
						List<account> listAc = (ArrayList) request.getAttribute("listAc");
						int i = 1;
					...
					<tr>
						...
						<td><a style="color: red;"
							href="${pageContext.request.contextPath}/DeleteAccout?idac=<%=ac.getUsername()%>">Xóa</a></td>
